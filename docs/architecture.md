...
Build thumbnails use a fixed noon hour. Rendering tests inject a fixed local hour to reproduce dawn, dusk, and night independently of animation time. The recorded dark WorkOS movie is a release preview asset; runtime wallpaper playback uses the native Metal renderer. The daily palette is artist-directed rather than tied to geographic sunrise or seasonal day length. Portal blends its neutral room lighting from night to day over 06:30–09:00 and from day to night over 17:00–20:30. Its original colored grazing lights keep their source colors and intensities across the day; their movement uses saved animation time. Additional silver and blue edge lights accompany the daytime window, with less ambient fill and a stronger cast shadow.
