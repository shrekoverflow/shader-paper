...
xcrun swiftc "${common[@]}" Sources/Shared/*.swift Tests/ResolutionTests.swift \
  -o build/native/test-resolution -framework AppKit -framework Metal -framework AVFoundation
build/native/test-resolution Resources
