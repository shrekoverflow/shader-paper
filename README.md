...
[![Watch the dark WorkOS wallpaper preview](docs/previews/Portal.png)](https://github.com/shrekoverflow/shader-paper/releases/download/v1.3.0/WorkOS-dark.mp4)

[Watch the recorded dark WorkOS preview (MP4)](https://github.com/shrekoverflow/shader-paper/releases/download/v1.3.0/WorkOS-dark.mp4). The app renders its wallpapers live through the native macOS wallpaper extension.
...
[Download the latest release](https://github.com/shrekoverflow/shader-paper/releases/latest) for Apple Silicon on macOS 26+. | ![Light](docs/previews/Light.png) | ![Weather](docs/previews/Weather.png) |
